...
class EnthusiaMarketConfig {
    ...
    class Auction {
        ...
        val antiSnipeWindowDuration: java.time.Duration
            get() {
                return java.time.Duration.ofSeconds(antiSnipeSec.toLong())
            }
        val antiSnipeExtensionDuration: java.time.Duration
            get() {
                return java.time.Duration.ofSeconds(antiSnipeExtendSec.toLong())
            }
