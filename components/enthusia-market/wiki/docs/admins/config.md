...
Each limit group maps to the permission node
...
Path: `plugins/EnthusiaMarket/entitylimits.yml`. Controls entity caps per region
kind. Never overwrites local edits.
