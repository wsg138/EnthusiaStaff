...
Authorization is enforced in authoritative services, not only GUI/commands.

### Mod

May apply configured steps, including configured permanent steps; lower recommended punishment; end/revoke while preserving history; remove escalation contribution when configured; request full overturn.

Cannot raise above recommendation, create arbitrary sanctions/combinations, or directly fully overturn.

### Developer

Developer is development staff, not moderation staff.

May retain read-only cases/history/reports/diagnostics and non-punishment staff/development tools.

May not create, confirm, raise, lower, end, revoke, remove, unban, unmute, remove warnings, change punishment visibility, request overturn, approve/deny overturn, or mutate punishments through commands, GUIs, APIs, website, or integrations.

Historical Developer-issued cases remain valid and preserve original actor/rank.

### Admin

May apply configured punishments, raise/lower, use custom durations with configured types, fully overturn, approve/deny requests, and reopen appeals as configured.
...
Entry: CombatLogX check, durable full snapshot, verify commit, clear normal state, apply staff state, mark active.
...
Ender access: Mod unavailable, Developer unavailable, Admin view-only, Founder normal. Creative: Mod no, Developer no, Admin yes, Founder yes.
...
Mod/Developer require staff mode. Admin/Founder may vanish independently.

Default visibility: Mod sees Mod/Developer; Developer sees Mod/Developer; Admin sees Mod/Developer/Admin but not Founder; Founder sees all. Configurable.
...
Mod/Developer remain survival-like, invulnerable, no creative items, smooth noclip/spectator shell, teleport-to-player, silent container mirrors. Admin/Founder capabilities configurable.
