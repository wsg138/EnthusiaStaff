...
| `/inspect` | `/inspect <player>` | Player inspector with freeze status and authorized shortcuts to history, client evidence, inventories and punishment review | `enthusiastaff.inspect`; each shortcut also requires its normal command permission |
