...
public final class StaffBotRuntime implements AutoCloseable {
    ...
    public void close() {
        ...
        String shutdownFailure = stopGateway();
    ...
    private String stopGateway() {
        ...
        try {
            ...
            gateway.shutdownNow();
            return gateway.awaitShutdown(Duration.ofSeconds(2)) ? null : "gateway_shutdown_timeout";
