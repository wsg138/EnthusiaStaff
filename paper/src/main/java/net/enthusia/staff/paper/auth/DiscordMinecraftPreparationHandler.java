...
final class DiscordMinecraftPreparationHandler {
    ...
    void handle(HttpExchange exchange) throws IOException {
        ...
        try {
            ...
            respond(exchange, HTTP_OK, MinecraftPunishmentPreparationCodec.encodeResponse(response), authorization);
    ...
    private MinecraftPunishmentPreparationWire.Response prepare(String body) {
        MinecraftPunishmentPreparationWire.Request wire = MinecraftPunishmentPreparationCodec.decodeRequest(body);
