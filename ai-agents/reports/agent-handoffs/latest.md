...
| State | `ACTIVE — implementation and focused tests committed; exact-head validation and review pending` |
...
| Tests | Exact handler presence, priority and cancelled-event metadata; existing runtime-state tests prove unrestricted, pending, confirmed and fenced lifecycle decisions |
