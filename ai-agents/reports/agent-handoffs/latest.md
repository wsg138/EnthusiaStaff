...
This worker stops after the documentation-only ES-P08 blocker state is normally merged to `main`. It preserves PR #128 and its frozen implementation branch.
