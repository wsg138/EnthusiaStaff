...
| Implementation | Helper/Mod/Developer cannot open; Admin can open but click/drag mutation is cancelled; Founder retains owner access |
| Tests | `StaffModeAccessPolicyTest` covers all five rank boundaries |
