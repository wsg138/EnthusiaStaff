...
| --- | --- | --- | --- | ---: | --- | --- |
| `ES-T01` | Random staff-teleport stale-target hardening | `ACTIVE` | `ACTIONABLE_CONTINUATION` | 5 | `ES-P04` | owner-authorized 2026-09-20 test-hardening repair; draft PR #215 on `package/es-t01-staff-teleport-hardening`; initial product `d69b48a8088c` superseded by same-package Folia repair; no active-package product-path collision |
