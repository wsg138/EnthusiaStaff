...
- The aggregate Market tree equals standalone `main` `cc19fa966dcb155fa1743f5076fb5152e74bdf8f` before Staff merge; its metadata remains `SYNC_PENDING`. Preserve separate standalone PR #6 rather than absorbing it and breaking parity.
