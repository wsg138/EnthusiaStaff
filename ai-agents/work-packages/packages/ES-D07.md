...
## Validation
Isolated staging guild/bot enforcement tests where available plus deterministic adapter tests for Discord failures/rate limits/restarts/expiry/hierarchy; MariaDB recovery tests; full CI/static/review. Never fake global success when Discord side effects are pending/failed.
