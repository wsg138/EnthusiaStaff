...
| `COMP-MARKET` | EnthusiaMarket | `components/enthusia-market/` | `wsg138/EnthusiaMarket` | `main` | `bc24f1010642d6042307bc13a32fb33cc94e8883` | `SYNC_PENDING` | ES-X03 candidate is imported and exactly matches standalone `62408695063d03303026766befb065a0f1f51044` at product hash `8d27f4d9...`; paired PR merge and post-merge parity remain. |
