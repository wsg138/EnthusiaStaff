...
| Exact next action | Finish only ES-P08: synchronize PR #128 normally with current `main`, prove the post-frozen-head delta is state/documentation-only, validate that delta and reviews, normally merge PR #128, verify containment/cleanup, then stop. |
